...
#keep adlive tests
    kamessage, response = determine_msg_type('\x00\x00\x00\x00trainling')
    ...
    cmessage, cresponse = determine_msg_type('\x00\x00\x00\x01\x00trainling')
    ...
    ucmessage, ucresponse = determine_msg_type('\x00\x00\x00\x01\x01trainling')
    ...
    imessage, iresponse = determine_msg_type('\x00\x00\x00\x01\x02trainling')
    ...
    nimessage, niresponse = determine_msg_type('\x00\x00\x00\x01\x03trainling')
    ...
    hmessage, hresponse = determine_msg_type('\x00\x00\x00\x05\x04\x00\x00\x00\xfftrainling')
    ...
    bmessage, bresponse = determine_msg_type('\x00\x00\x00\x10\x05\x00\x00\x00\xff\x00\xff\x01\x02\x55\xef\x90\x12\x14\x11\x01trainling')
    ...
    rmessage, rresponse = determine_msg_type('\x00\x00\x00\x0d\x06\x00\x00\x00\xff\x00\xff\x01\x02\x00\xef\x90\x00trainling')
    ...
    pmessage, presponse = determine_msg_type('\x00\x00\x00\x15\x07\x00\x00\x01\xff\x00\x00\x01\x02\x00\xef\x90\x00\x00\x00\x03\x05\x01\x93\xab\x33trainling')
    ...
    camessage, caresponse = determine_msg_type('\x00\x00\x00\x0d\x08\x00\x00\x01\xff\x00\x00\x01\x02\x00\xef\x90\x00trainling')
    ...
    pomessage, poresponse = determine_msg_type('\x00\x00\x00\x03\x09\x11\x01trainling')
